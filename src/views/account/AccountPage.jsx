...
const AccountPage = () => {
  const { authData,isLoggedIn,isAdmin } = useContext(AuthContext);
        ...
        <div className="sc-wrapper">
          <div className="account-details bg-white grid">
            ...
            <div className="account-details-right">
             ...
             {/* Conditionally render the "Product Management" link for admin users */}
             {isLoggedIn && isAdmin && (
                <li className='nav-item'>
                  <button to="/productmanagement" className='nav-link no-wrap'>
                    Product Management
                  </button>
                </li>
              )}
